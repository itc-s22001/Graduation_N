...
// // import SearchBar from "@/app/SearchBar"; // SearchBar on the right side
...
//                 // フォロワーの数を取得
//                 const followerQuery = query(collection(db, "followers"), where("following_id", "==", user.uid));
...
//                             <img className="profile-image" src={userData.profile_image_url} alt="Profile" />
//                         ) : (
//                             <p>アイコンが設定されていません</p>
//                         )}
...
//                     <div className="logout-divider"></div> {/* Black line below logout button */}
